...
<main id="main">
  ...
  <section class="af-section">
    <div class="af-container">
      ...
      <div class="af-diagram">
        <figure class="af-diagram__figure">
          <img src="assets/projects-overview.svg" alt="Overview diagram: AikiField sponsors five projects — AikiField AI Chat (inputs: member question and teaching corpus; core: Gemini API, SQLite FTS5, Cloud Run, Firestore, rate limiter, auth; outputs: cited answer and human coach escalation), World Studio Finder (inputs: Google Maps, Places API, Hunter.io; core: Playwright scraper, email verifier, SQLite SCD Type 2, Google Sheets sync, geo-filter, Compute Engine; outputs: YAMM email campaigns and web form submission), ChaosEngine (inputs: staging environment targets and experiment specs; core: Go experiment engine, blast-radius limiter, dry-run mode, AWS SDK/CLI, Docker, CI/CD approval gates; outputs: chaos experiment reports and automatic rollback), ClipQuotes (inputs: long-form video/audio and target quote query; core: Whisper transcription, pyannote.audio diarization, OpenCV face tracking, FFmpeg extraction, Flask; outputs: timestamped, accurately framed video clips), and Voice Synthesis Benchmarking (inputs: consented voice datasets and candidate TTS/voice-conversion models; core: PyTorch, torchaudio, Hugging Face Transformers, GPU inference pipelines, provenance and consent controls; outputs: naturalness and speaker-similarity benchmark reports and failure-mode documentation)." class="af-diagram__img" width="1120" height="760" loading="lazy"/>
          <figcaption class="af-diagram__caption"><strong>Figure 3.</strong> Overview of the five systems AikiField built, showing inputs, core components, and outputs for each. <a href="assets/projects-overview.png" class="af-diagram__download" download>Download PNG &darr;</a></figcaption>
        </figure>
      </div>
    </div>
  </section>
