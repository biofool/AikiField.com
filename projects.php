...
<main id="main">
  ...
  <!-- ============================================================ -->
  <!-- PAGE HEADER — leads the Sponsored Projects page              -->
  <!-- ============================================================ -->
    ...
    <div class="af-container">
      <div class="af-projects-split">
        ...
        <div class="af-projects-split__chat" id="ai-chat">
          ...
          <!-- Privacy notice — collapsible to save space in the chat rail -->
          <details id="coach-privacy-notice" class="coach-card coach-privacy-notice">
            <summary><h2>Privacy notice</h2></summary>
    ...
    <div class="af-container">
      ...
      <div class="af-diagram">
        <figure class="af-diagram__figure">
          ...
          <figcaption class="af-diagram__caption"><strong>Figure 3.</strong> Overview of AikiField&rsquo;s two sponsored projects, showing inputs, core components, and outputs for each. <a href="assets/projects-overview.png" class="af-diagram__download" download>Download PNG &darr;</a></figcaption>
        </figure>
      </div>
    </div>
  </section>
