 ...
 *
 * Authenticates against the Activating Infinite Creativity backend (AIRichardMoon
        ...
        <form id="coach-register-form" class="coach-form">
          <div class="coach-reg-columns">
            ...
            <div class="coach-reg-col coach-reg-optional">
              ...
              <p class="coach-reg-hint">Overrides auto-detection. Activating Infinite Creativity will respond in this language.</p>
            </div>
          </div>
      ...
      <details class="coach-login-caveats" open>
        ...
        <div class="coach-intro-panel coach-intro-panel--highlight">
          ...
          <p class="coach-intro-text">
            ...
            are an Activating Infinite Creativity member.
          </p>
        ...
        <div id="coach-privacy-notice" class="coach-card coach-privacy-notice">
          ...
          <ul class="coach-privacy-list">
            ...
            <li>Authentication is handled by the Activating Infinite Creativity backend on Google Cloud Run.</li>
