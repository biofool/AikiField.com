...
<head>
  ...
  <meta name="description" content="Index of unreleased beta previews on aikifield.com. Gated — requires coaching chat login.">
...
<main id="main" class="bta-main">
  ...
  <section class="bta-hero">
    ...
    <div class="bta-container bta-hero__inner">
      ...
      <p class="bta-lead">Unreleased previews behind the coaching-chat login. Nothing here is linked from the main site, and the content is still changing.</p>
    </div>
  </section>
